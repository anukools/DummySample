...
import com.sample.shopapp.cache.Cache;
import com.sample.shopapp.controllers.Home;
import com.sample.shopapp.events.RefreshCartEvent;
import com.sample.shopapp.models.AvailableOption;
import com.sample.shopapp.models.Image;
import com.sample.shopapp.models.LineItem;
import com.sample.shopapp.models.Order;
import com.sample.shopapp.models.Product;
import com.sample.shopapp.models.ProductProperty;
import com.sample.shopapp.models.User;
import com.sample.shopapp.models.Variant;
...
import com.sample.shopapp.viewhelpers.ProductDetailColorOptionHelper;
import com.sample.shopapp.viewhelpers.ProductDetailOptionHelper;
import com.sample.shopapp.viewhelpers.RatingStarsHelper;
    ...
    private void setListeners() {
        ...
        reviewContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (product.getRatingsCount() == 0)
                    home.showAddReviewFragment(productId, product.getName(), product.getDisplayPrice());
                else
                    home.showReviewFragment(productId, product.getName(), product.getDisplayPrice());
            }
        });
